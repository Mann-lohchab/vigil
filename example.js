...
app.listen(PORT, () => {
  ...
  console.log(`  curl -X POST -H "Content-Type: application/json" -d '{"email":"test@gmail.com"}' http://localhost:${PORT}/api/email/check`);
  console.log(`\nCheck disposable email:`);
  console.log(`  curl -X POST -H "Content-Type: application/json" -d '{"email":"test@mailinator.com"}' http://localhost:${PORT}/api/email/check`);
});
